...
export async function POST(request: NextRequest) {
    ...
    try {
        ...
        if (!signatureData.proofHash || !signatureData.signature || !signatureData.publicKey) {
        ...
        console.log('Numbers Protocol API response:', JSON.stringify(data, null, 2));
        ...
        const formattedResponse = {
            ...
            nft: {
                ...
                verificationData: {
                    isValid: true,
                    recoveredAddress: data.owner_addresses?.asset_wallet_address || signatureData.publicKey
                }
            },
            signatureData: {
                ...
                publicKey: data.owner_addresses?.asset_wallet_address || signatureData.publicKey,
