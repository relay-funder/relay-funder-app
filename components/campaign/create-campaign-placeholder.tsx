...
export function CreateCampaignPlaceholder({
  ...
  return (
    <Card
      className={`flex h-full cursor-pointer flex-col overflow-hidden border-2 border-dashed border-gray-400 transition-all duration-300 hover:shadow-lg ${className || ''} `}
      onClick={onCreate}
    >
      <CardContent className="flex flex-1 flex-col items-center justify-center p-8 text-center">
        <div className="relative mb-6">
          {/* Icon with decorative elements */}
          <div className="relative inline-flex h-20 w-20 items-center justify-center rounded-full border-2 border-gray-300">
