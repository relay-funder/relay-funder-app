...
interface RoundCreateProcessDisplayProps {
...
> = {
  setup: {
    ...
    description: 'We are setting up the transaction that creates the round.',
  },
  create: {
    title: 'Create Round in Database',
    description: 'We store your inputs in the database.',
  },

  idle: {
    title: 'Ready to Start',
    description: 'The round creation process is ready to begin.',
  },
  done: {
    title: 'Creation Complete!',
    description: 'Your round has been successfully created.',
  },
  failed: {
    title: 'Creation Failed',
    description:
      'Unfortunately, your round could not be created. Please review the error message or try again.',
  },
};

export function RoundCreateProcessDisplay({
  currentState,
  failureMessage,
  onFailureCancel,
  onFailureRetry,
}: RoundCreateProcessDisplayProps) {
